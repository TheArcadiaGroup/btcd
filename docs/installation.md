...
* Download the Conformal public key:
  https://raw.githubusercontent.com/TheArcadiaGroup/firod/master/release/GIT-GPG-KEY-conformal.txt
...
* Install the MSI available at: [btcd windows installer](https://github.com/TheArcadiaGroup/firod/releases)
...
```bash
git clone https://github.com/TheArcadiaGroup/firod $GOPATH/src/github.com/TheArcadiaGroup/firod
...
* [Using bootstrap.dat](https://github.com/TheArcadiaGroup/firod/blob/master/docs/configuration.md#using-bootstrapdat)
