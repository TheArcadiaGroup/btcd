...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/TheArcadiaGroup/firod/peer)
...
```bash
$ go get -u github.com/TheArcadiaGroup/firod/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/TheArcadiaGroup/firod/peer#example-package--NewOutboundPeer)  
